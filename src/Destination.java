...
public class Destination extends JFrame implements Runnable {
    ...
    public Destination() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/dest2.jpg"));
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("icons/dest7.jpg"));
